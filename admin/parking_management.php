...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <a href="init_parking.php" class="btn btn-success" onclick="return confirm('This will create all 5 parking areas (A-E) and 100 parking spaces. Continue?');">
                            ...
                            <tbody>
                                <?php foreach ($areas as $area): ?>
                                    <tr>
                                        ...
                                        <td><span class="badge badge-success"><?php echo $area['space_count']; ?> spaces</span></td>
                                        <td><?php echo date('M j, Y', strtotime($area['created_at'])); ?></td>
                                        <td class="action-btns">
                                            <button type="button" class="btn btn-primary btn-sm" onclick='editArea(<?php echo htmlspecialchars(json_encode($area), ENT_QUOTES, "UTF-8"); ?>)'>
                                                ✏️ Edit
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteArea(<?php echo $area['area_id']; ?>, '<?php echo htmlspecialchars($area['area_name'], ENT_QUOTES); ?>')">
                                                🗑️ Delete
                                            </button>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                <?php foreach ($spaces as $space): ?>
                                    <tr>
                                        ...
                                        <td class="action-btns">
                                            <button type="button" class="btn btn-primary btn-sm" onclick='editSpace(<?php echo htmlspecialchars(json_encode($space), ENT_QUOTES, "UTF-8"); ?>)'>
                                                ✏️ Edit
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteSpace(<?php echo $space['Space_id']; ?>, '<?php echo htmlspecialchars($space['space_number'], ENT_QUOTES); ?>')">
                                                🗑️ Delete
                                            </button>
                                        </td>
                                    </tr>
            ...
            <form id="spaceForm" onsubmit="submitSpaceForm(event)">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="space_number" name="space_number" placeholder="e.g., A-01, B-15" required>
                    </div>
            ...
            <form id="bulkSpaceForm" onsubmit="submitBulkSpaceForm(event)">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bulk_prefix" name="prefix" placeholder="e.g., A, B, C" required maxlength="5">
