...
CREATE TABLE Booking (
    ...
    status ENUM('pending', 'checked_in', 'completed', 'cancelled') DEFAULT 'pending',
...
-- Sample Vehicles
INSERT INTO Vehicle (user_id, vehicle_type, vehicle_model, license_plate, Approved_date) VALUES
(3, 'Car', 'Toyota Camry', 'ABC123', NOW()),
(3, 'Motorcycle', 'Honda CBR', 'XYZ789', NOW()),
(4, 'Car', 'BMW 3 Series', 'DEF456', NOW());
