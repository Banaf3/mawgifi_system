...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logout-btn:hover { background: #e53e3e; border-color: #e53e3e; }
        ...
        .slot-display .slot-id { font-size: 1.8rem; font-weight: bold; }
        .slot-display .slot-label { font-size: 0.8rem; opacity: 0.9; }
        ...
        .qr-section img { background: #fff; padding: 5px; border-radius: 4px; }
        .qr-section p { font-size: 0.75rem; color: #888; margin-top: 5px; }
        ...
        .placeholder-text span { font-size: 2rem; display: block; margin-bottom: 8px; }
        ...
        .no-vehicle-msg a { color: #92400e; font-weight: 600; }
        ...
        /* Slot styles */
        .parking-slot { cursor: pointer; transition: all 0.2s; }
        .parking-slot:hover { fill: #48bb78 !important; }
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <?php elseif ($user_type === 'admin'): ?>
                ...
                <a href="../../Moudel1/Admin.php?view=vehicles">Vehicles</a>
                <a href="../parking/index.php" class="active">Parking Areas</a>
                <a href="../../Moudel1/Admin.php?view=bookings">Bookings</a>
